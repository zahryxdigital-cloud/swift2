...
import { Anchor, CheckCircle, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-6">
              Marine Repair & Workshop<br />
              <span className="text-gradient-gold">Manpower Supply</span>
            </h1>
            <p className="text-muted text-sm leading-relaxed mb-8">
              Supporting the maritime industry with experienced marine technicians, workshop staff, and skilled trades for
              ship repair, maintenance, and fabrication work across UAE ports and shipyards.
            </p>
            <Link
              href="/contact"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              "HSE-compliant personnel for marine operations",
            ].map((item) => (
